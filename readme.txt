...
standard device tree tools: dtc -@ -I dts -O dtb -o MCC_118.dtbo MCC_118-overlay.dts
...
standard device tree tools: dtc -@ -I dts -O dtb -o MCC_152.dtbo MCC_152-overlay.dts
